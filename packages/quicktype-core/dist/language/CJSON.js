...
class CJSONRenderer extends ConvenienceRenderer_1.ConvenienceRenderer {
    ...
    memberNameStyle; /* Member name style */
    namedTypeNameStyle; /* Named type name style */
    forbiddenGlobalNames; /* Forbidden global names */
    typeIntegerSize; /* Integer code generation type */
    hashtableSize; /* Hashtable default size */
    typeNamingStyle; /* Type naming style */
    enumeratorNamingStyle; /* Enum naming style */
    /**
     * Constructor
