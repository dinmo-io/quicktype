...
jq --arg version $VERSION \
    '.dependencies."quicktype-core" = $version | .dependencies."quicktype-graphql-input" = $version | .dependencies."from "@quicktype/typescript-input"" = $version' \
...
jq --arg version $VERSION \
    ...
    packages/from "@quicktype/typescript-input"/package.json > package.1.json
    
mv package.1.json packages/from "@quicktype/typescript-input"/package.json
